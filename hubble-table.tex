...
\begin{tabular}{llr}
\hline
\multicolumn{1}{c}{Item} &            \\ \cline{1-4}
Equation     & Description & Result (Gly) & Result (G)\\ \hline
with j       & per gram    & 13.65        & 13.65     \\
with pi      & each        & 0.01         & 0.01      \\
with Lucas   & stuffed     & 92.50        & 0.01      \\
with 2       & stuffed     & 33.33        & 0.01      \\
Nambu        & frozen      & 8.99         & 0.01      \\ \hline
\end{tabular}
\end{table}
